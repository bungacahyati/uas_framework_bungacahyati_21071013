...
use App\Http\Controllers\NilaiBungaController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaiBungaController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaiBungaController::class, 'cetak_nilai'])->name('cetak_nilai');
